return {
  all = function(colors)
    return {
      ...
      NotifyBackground = { bg = colors.mantle, blend = 30 },
      NoicePopup = { bg = colors.mantle, blend = 30 },
      ...
      NeoTreeFloatNormal = { fg = colors.subtext1 },
      NeoTreeFloatTitle = { fg = colors.overlay1 },
      ...
      TSConstBuiltin = { fg = colors.mauve, italic = true, cterm = { italic = true } },
      TSConstMacro = { fg = colors.mauve, italic = true, cterm = { italic = true } },
      ...
      TSKeyword = { fg = colors.red, italic = true, cterm = { italic = true } },
      TSKeywordFunction = { fg = colors.red, italic = true, cterm = { italic = true } },
      TSKeywordOperator = { fg = colors.peach },
      TSKeywordReturn = { fg = colors.red, italic = true, cterm = { italic = true } },
